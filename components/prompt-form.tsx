...
export function PromptForm({
  ...
  const [researchMode] = useLocalStorage('researchMode', true)
    ...
    <form
      ...
      onSubmit={async (e: any) => {
        ...
        setMessages(currentMessages => {
          ...
          const replaced = currentMessages.map(message =>
            message.id === placeholderId ? responseMessage : message
          )
          return replaced.some(message => message.id === responseMessage.id)
            ? replaced
            : [...replaced, responseMessage]
        })
      }}
    >
